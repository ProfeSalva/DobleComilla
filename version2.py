...
Establecimientos = pd.read_excel("C:/Users/Usuario/Downloads/Datos para el TP/2022_padron_oficial_establecimientos_educativos.xlsx", skiprows=6, usecols= columnas_ee)
...
padron_poblacional = pd.read_excel("C:/Users/Usuario/Downloads/Datos para el TP/padron_poblacion.xlsX", skiprows=12, header=None)
...
deptos_actividad_genero = pd.read_csv("C:/Users/Usuario/Downloads/Datos para el TP/Datos_por_departamento_actividad_y_sexo.csv")
